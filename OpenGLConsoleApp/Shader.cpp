...
void Shader::CreateFromString(const char* vertrxCode, const char* fragmenCode)
{
	CompileShader(vertrxCode, fragmenCode);
}
...
// private
void Shader::CompileShader(const char* vertrxCode, const char* fragmenCode)
{
	...
	AddShader(shaderID, vertrxCode, GL_VERTEX_SHADER);
